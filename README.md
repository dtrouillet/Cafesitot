...
Master build [![Build Status](https://travis-ci.org/kms77/Cafesitot.svg?branch=master)](https://travis-ci.org/kms77/Cafesitot)
...
To optimize the CafeSiTot application for production, run:
